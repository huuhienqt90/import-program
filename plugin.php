<?php
/*
Plugin Name: Import Program
Plugin URI: https://github.com/huuhienqt90/import-program/
Description: Import program post type from zip file
Version: 1.0.0
Author: Hien(Hamilton) H.HO
Author URI: https://github.com/huuhienqt90
Text Domain: import-program
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
}
define( '__TEXTDOMAIN__', 'import-program' );
...
if ( ! class_exists( 'ImportProgram' ) ) :
    class ImportProgram{
        ...
        /**
         * Do cron notification
         */
        public function do_cron_notification(){
            global $wpdb;
         ...
         * Edit post group by
         */
		public function edit_posts_groupby($groupby) {
		...
		/**
         * Edit post join paged
         */
		public function edit_posts_join_paged($join_paged_statement) {
			global $wpdb, $is_search_program;
         ...
         * Edit post order by
         */
		public function edit_posts_orderby($orderby_statement) {
			global $wpdb, $is_search_program;
			if($is_search_program ){
        ...
        /**
         * Post where statement
         */
		public function posts_where_statement( $where ) {
        ...
        public function init(){
            global $wpdb;
            ImportProgram::defines();
            ImportProgram::includes();
            ImportProgram::register_post_type();
            ImportProgram::register_taxonomy();
            ImportProgram::load_plugin_textdomain();
            ...
            if( isset( $_REQUEST['check_cron']) ){
                ImportProgram::do_cron_notification();
                die();
            }
            if( isset( $_REQUEST['create_json']) && $_REQUEST['create_json'] == 'yes' ){
                ImportProgram::create_json_file();
                die();
            }
         ...
         */
        public function front_plugin_scripts(){
         ...
         * Display Tab Import
         */
        public function import_tab_import(){
         ...
         */
        public function import_tab_select_option(){
         ...
         */
        public function search_filters_page(){
        ...
        public function load_plugin_textdomain() {
            $locale = apply_filters( 'plugin_locale', get_locale(), __TEXTDOMAIN__ );
            ...
            load_textdomain( __TEXTDOMAIN__, $dir . 'izweb-import/izweb-import-' . $locale . '.mo' );
            load_plugin_textdomain( __TEXTDOMAIN__, false, plugin_basename( dirname( __FILE__ ) ) . "/languages" );
        }
         ...
         */
        public function izw_search_ajax(){
            global $wpdb;
         ...
         * @return array
         */
        public function hh_add_query_vars($vars) {
         ...
         * @return string
         */
        public function hh_search_display( $include ) {
         ...
         * @return string
         */
        public function hh_change_title( $title, $sep ){
         ...
         */
        public function my_ag_child_theme_setup() {
         ...
         * @return string
         */
        public function my_nectar_milestone($atts, $content = null) {
